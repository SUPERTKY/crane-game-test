...
// ===== 爪ヒットボックス設定（ここだけいじる）=====
// ★ 方法B: 基準点が「爪メッシュの原点」になったので、
//    ヒットボックスは爪メッシュの原点からの相対位置です。
//    緑/赤のワイヤーフレームを見ながら微調整してください。
const HB_SCALE = 1.0;            // 全体倍率

const HB_Y = 0.0;                // 1個目のY（メッシュ原点 = 0 から開始）

const HB_GAP1 = -0.12;           // 2個目までのY差

const HB_GAP2 = -0.10;           // 3個目までのY差
...
// halfExtents（半分サイズ）
const HB1 = { x: 0.10, y: 0.12, z: 0.08 };

const HB2 = { x: 0.08, y: 0.08, z: 0.10 };

const HB3 = { x: 0.06, y: 0.06, z: 0.08 };
...
// 個別調整したいならこっち
const HB1_ROT = { x: 40 * Math.PI / 180, y: 0, z: 0 }; // 40度→ラジアンに変換
